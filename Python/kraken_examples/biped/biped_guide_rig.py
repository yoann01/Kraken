...
class BipedGuideRig(Rig):
    """Base biped guide rig.

    This guide rig is used within the Kraken DCC plug-ins as a simple template for
    users to get a basic biped rig built for their characters.
